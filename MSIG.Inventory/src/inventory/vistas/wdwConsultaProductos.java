...
public class wdwConsultaProductos extends javax.swing.JInternalFrame {
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addComponent(txtPrecioMinimo, javax.swing.GroupLayout.DEFAULT_SIZE, 82, Short.MAX_VALUE))
    ...
    private void btnAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAgregarActionPerformed
        ...
        if ((Float.parseFloat(txtPrecio.getText()) >= Float.parseFloat(txtPrecioMinimo.getText()) && Float.parseFloat(txtPrecio.getText()) <= Float.parseFloat(txtPrecioNormal.getText())) || Inventory.lblRol.getText().equals("Administrador")) {
            try {
                //sacar el total vendido
                float total = Float.parseFloat(txtCantidadProducto.getText()) * Float.parseFloat(txtPrecio.getText());

                try {
                    //enviar datos a la pantalla de ventas
                    wdwMovimientoVentaDeProductos.tblDetalleFactura.setValueAt(wdwMovimientoVentaDeProductos.tblDetalleFactura.getSelectedRow() + 1, wdwMovimientoVentaDeProductos.tblDetalleFactura.getSelectedRow(), 0);
                    wdwMovimientoVentaDeProductos.tblDetalleFactura.setValueAt(txtIdProducto.getText(), wdwMovimientoVentaDeProductos.tblDetalleFactura.getSelectedRow(), 1);
                    wdwMovimientoVentaDeProductos.tblDetalleFactura.setValueAt(txtDescripcionProducto.getText(), wdwMovimientoVentaDeProductos.tblDetalleFactura.getSelectedRow(), 2);
                    wdwMovimientoVentaDeProductos.tblDetalleFactura.setValueAt(Float.parseFloat(txtCantidadProducto.getText()), wdwMovimientoVentaDeProductos.tblDetalleFactura.getSelectedRow(), 3);
                    wdwMovimientoVentaDeProductos.tblDetalleFactura.setValueAt(Float.parseFloat(txtPrecio.getText()), wdwMovimientoVentaDeProductos.tblDetalleFactura.getSelectedRow(), 4);
                    wdwMovimientoVentaDeProductos.tblDetalleFactura.setValueAt(Float.parseFloat(txtPrecioMinimo.getText()), wdwMovimientoVentaDeProductos.tblDetalleFactura.getSelectedRow(), 5);
                    wdwMovimientoVentaDeProductos.tblDetalleFactura.setValueAt(Float.parseFloat(txtPrecioNormal.getText()), wdwMovimientoVentaDeProductos.tblDetalleFactura.getSelectedRow(), 6);
                    wdwMovimientoVentaDeProductos.tblDetalleFactura.setValueAt(total, wdwMovimientoVentaDeProductos.tblDetalleFactura.getSelectedRow(), 7);
                    wdwMovimientoVentaDeProductos.tblDetalleFactura.setValueAt("S/C", wdwMovimientoVentaDeProductos.tblDetalleFactura.getSelectedRow(), 8);
                    wdwMovimientoVentaDeProductos.tblDetalleFactura.setValueAt(0.0, wdwMovimientoVentaDeProductos.tblDetalleFactura.getSelectedRow(), 9);
                    totalFactura();
                } catch (Exception e) {
                }
                
                try {
                    //enviar datos a la pantalla de la proforma
                    wdwMovimientoProforma.tblDetalleProforma.setValueAt(wdwMovimientoProforma.tblDetalleProforma.getSelectedRow() + 1, wdwMovimientoProforma.tblDetalleProforma.getSelectedRow(), 0);
                    wdwMovimientoProforma.tblDetalleProforma.setValueAt(txtIdProducto.getText(), wdwMovimientoProforma.tblDetalleProforma.getSelectedRow(), 1);
                    wdwMovimientoProforma.tblDetalleProforma.setValueAt(txtDescripcionProducto.getText(), wdwMovimientoProforma.tblDetalleProforma.getSelectedRow(), 2);
                    wdwMovimientoProforma.tblDetalleProforma.setValueAt(Float.parseFloat(txtCantidadProducto.getText()), wdwMovimientoProforma.tblDetalleProforma.getSelectedRow(), 3);
                    wdwMovimientoProforma.tblDetalleProforma.setValueAt(Float.parseFloat(txtPrecio.getText()), wdwMovimientoProforma.tblDetalleProforma.getSelectedRow(), 4);
                    wdwMovimientoProforma.tblDetalleProforma.setValueAt(Float.parseFloat(txtPrecioMinimo.getText()), wdwMovimientoProforma.tblDetalleProforma.getSelectedRow(), 5);
                    wdwMovimientoProforma.tblDetalleProforma.setValueAt(Float.parseFloat(txtPrecioNormal.getText()), wdwMovimientoProforma.tblDetalleProforma.getSelectedRow(), 6);
                    wdwMovimientoProforma.tblDetalleProforma.setValueAt(total, wdwMovimientoProforma.tblDetalleProforma.getSelectedRow(), 7);
                    totalProforma();
                } catch (Exception e) {
                }
                ...
                //cerrar la pantalla luego de pasar los datos
                this.dispose();
            }
        } else {
            Mensaje.manipulacionExcepciones("critico", "El precio no corresponde al rango aceptado");
        }
    ...
    private void totalFactura(){
        ...
        Double total_iva = Double.parseDouble(wdwMovimientoVentaDeProductos.txtTotalFactura.getText()) - ( Double.parseDouble(wdwMovimientoVentaDeProductos.txtTotalFactura.getText()) / 1.12 );
