 ...
 */
public class wdwReporteAbonosClienteDetalle extends javax.swing.JInternalFrame {

    /**
     * Creates new form wdwReportesVentasPorFecha
     */
    public wdwReporteAbonosClienteDetalle() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        lblTitulo.setText("Abonos por Cliente Detalle");
        ...
        lblFechaInicial1.setText("NIT");

        txtNit.setToolTipText("Debe de ingresar el NIT del cliente");
    ...
    private void btnGenerarReporteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGenerarReporteActionPerformed
       ...
       AccesoExcepciones Mensaje = new AccesoExcepciones();
        ...
        try {
            ...
            URL url_reporte = this.getClass().getResource("/inventory/reportes/rptAbonosPorClienteDetalle.jasper");
            ...
            if (txtNit.getText().isEmpty()) {
                parametro.put("P_NIT", null);
            } else {
               parametro.put("P_NIT", txtNit.getText()); 
            }
