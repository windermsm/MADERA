...
public class wdwMovimientoVentasActivas extends javax.swing.JInternalFrame {
    ...
    private void mostrarVentasActivas(){
        ...
        if(!lista.isEmpty()){
            ...
            tabla.addColumn("Monto Credito");
            tabla.addColumn("Monto Contado");
    ...
    private void initComponents() {
        ...
        btnReporte1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/inventory/imagenes/printer_w.png"))); // NOI18N
        btnReporte1.setText("Matricial");
        ...
        pnlBotonesLayout.setHorizontalGroup(
            ...
            .addGroup(pnlBotonesLayout.createSequentialGroup()
                ...
                .addComponent(cbxTipoImpresion, javax.swing.GroupLayout.PREFERRED_SIZE, 145, javax.swing.GroupLayout.PREFERRED_SIZE)
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(txtAutorizacionFEL, javax.swing.GroupLayout.DEFAULT_SIZE, 290, Short.MAX_VALUE))
    ...
    private void tblDetalleVentaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblDetalleVentaMouseClicked
        ...
        if (String.valueOf(tblDetalleVenta.getSelectedColumn()).equals("0")) {   
            ...
            txtNombrePersona.setText(tblDetalleVenta.getValueAt(fila_seleccionada, 8).toString());
    ...
    private void codigoImpresionAnterior() {
        ...
        try {
            ...
            System.out.println("Tipo Factura: " + tipo_factura);
    ...
    private void btnReporte1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnReporte1ActionPerformed
        ...
        MaestroFactura encabezado = new MaestroFactura();
        List<Producto> detalle = new ArrayList();
        
        //realizar consulta del encabezado de la factura
        List<ObjetosFactura> lista_facturas = new ArrayList();
        AccesoFactura acceso_factura = new AccesoFactura();
        AccesoCliente acceso_cliente = new AccesoCliente();
        
        lista_facturas = acceso_factura.buscarFacturaPorId(txtIdVenta.getText());
        
        //obtener la hora en la que se esta imprimiendo
        Calendar calendario = Calendar.getInstance();
        int hora, minuto;
        hora =calendario.get(Calendar.HOUR_OF_DAY);
        minuto = calendario.get(Calendar.MINUTE);

        for(ObjetosFactura x : lista_facturas){
            encabezado.setFecha(x.getFecha_emision_factura());
            encabezado.setHora(hora + ":" + minuto);
            encabezado.setNo_pedido(String.valueOf(x.getId_factura()));
            encabezado.setNo(String.valueOf(x.getNumero_factura()));
            encabezado.setNombre_cliente(acceso_cliente.buscarNombreCliente(x.getId_cliente()).toUpperCase());
            encabezado.setNit(acceso_cliente.buscarNitCliente(x.getId_cliente()));
            encabezado.setCodigo(String.valueOf(x.getId_cliente()));
            encabezado.setDireccion(x.getDir_envio_factura().toUpperCase());
            encabezado.setVendedor(String.valueOf(x.getId_empleado()));
        }
        
        Factura factura = new Factura();
        factura.setMaestro(encabezado);
        
        //realizar consulta para agregar el detalle de la factura
        List<ObjetosDetalleFactura> lista_detalle = new ArrayList();
        AccesoDetalleFactura acceso_detalle = new AccesoDetalleFactura();
        AccesoProducto acceso_producto = new AccesoProducto();
        lista_detalle = acceso_detalle.buscarDetalleFactura(Integer.parseInt(txtIdVenta.getText()));

        for(ObjetosDetalleFactura y : lista_detalle){
            Producto linea = new Producto();
            linea.setCantidad((int) y.getCant_d_factura());
            linea.setDescripcion(acceso_producto.buscarDescripcion(y.getId_producto()).toUpperCase());
            linea.setPrecioUnitario(y.getPrecio_venta_d_factura());
            linea.setPrecioParcial(y.getSub_total_d_factura());
            detalle.add(linea);
        }
        
        factura.setProductos(detalle);
        Impresion impresion = new Impresion(factura);
        impresion.generarArchivoPDF();
